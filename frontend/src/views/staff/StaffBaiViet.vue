      ...
      <div class="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
        <table class="w-full text-sm">
          ...
          <tbody class="divide-y divide-gray-100">
            <tr v-for="bv in danhSachLocByKeyword" :key="bv.maBV" class="hover:bg-blue-50/50 transition-colors">
      ...
      <div class="bg-white rounded-2xl shadow-2xl w-full max-w-2xl my-8">
        ...
        <div class="p-6 space-y-4">
          ...
          <div class="space-y-1.5">
            ...
            <div class="flex gap-2">
              <select v-model="form.maLoaiBV"
                class="flex-1 border border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-400 bg-white">
              ...
              <button @click="moModalThemLoai" type="button"
                class="flex items-center gap-1 bg-gray-50 hover:bg-gray-100 text-gray-700 font-medium px-4 py-2.5 rounded-xl border border-gray-200 transition-colors">
                <span class="material-symbols-outlined text-[18px]">add</span>
                Thêm Mới
              </button>
            </div>
          ...
          <div class="space-y-1.5">
            ...
            <textarea v-model="form.noiDung" rows="8" placeholder="Nhập nội dung bài viết..."
              class="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-400 resize-y"></textarea>
          </div>

          <!-- Trạng Thái -->
          <div class="flex items-center gap-3">
            <input type="checkbox" id="trangThaiCheck" v-model="form.trangThai" class="w-4 h-4 accent-blue-600"/>
        ...
        <div class="flex justify-end gap-3 px-6 py-4 border-t border-gray-100 bg-gray-50 rounded-b-2xl">
          ...
          <button @click="luuBaiViet" :disabled="dangLuu"
            class="px-5 py-2.5 rounded-xl bg-blue-600 hover:bg-blue-700 text-white text-sm font-semibold shadow-sm transition-colors disabled:opacity-60">
      ...
      <div class="bg-white rounded-2xl shadow-2xl w-full max-w-sm">
        ...
        <div class="p-6">
          ...
          <input v-model="tenLoaiMoi" @keyup.enter="luuLoaiBaiViet" placeholder="Vd: Xu hướng 2024..."
            class="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-400" autofocus />
        </div>
        <div class="flex justify-end gap-3 px-6 py-4 border-t border-gray-100 bg-gray-50 rounded-b-2xl">
...
export default {
  ...
  methods: {
    // Dùng chung API với Admin vì role NHANVIEN cũng có quyền /api/admin/blogs
    async taiDuLieu() {
      try {
