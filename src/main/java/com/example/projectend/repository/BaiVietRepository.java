...
public interface BaiVietRepository extends JpaRepository<BaiViet, Long> {
    ...
    Page<BaiViet> findByTrangThaiOrderByNgayDangDesc(Boolean trangThai, Pageable pageable);

    // Tìm bài viết theo tiêu đề (search)
    Page<BaiViet> findByTieuDeContainingIgnoreCaseAndTrangThaiOrderByNgayDangDesc(String tieuDe, Boolean trangThai, Pageable pageable);
